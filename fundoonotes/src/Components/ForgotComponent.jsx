...
handleClose=()=>{
   ...
   handleSubmitForgot=()=>{
        if (this.state.emailId === "") {
            ...
            forgot(data).then((res) => {
                console.log("response after login", res);
                localStorage.setItem('FundooUserToken',res.data.result)
                // this.props.history.push('/login');
                this.props.history.push('/reset')
                this.setState({ snackbarOpen: true, snackbarMsg: "Message Sent check Your Mail" })
            }).catch(err => {
            ...
            <div className='forgot_Container'>
                <Card className='forgot_Card'>
                    <div className='forgot_title'>
                        ...
                        <div style={{display:"flex", justifyContent:"center",marginTop:17, color: 'black', fontFamily: 'TimesNewRoman', fontSize: 25 }}>Find Your Email</div>
                        <div style={{display:"flex", justifyContent:"center",marginTop:17, color: 'black', fontFamily: 'TimesNewRoman', fontSize: 25 }}>Enter Your Recovery Email</div>
                    </div>
                    ...
                    <div className='forgot_button'>
                        ...
                        color='primary' style={{fontSize:18,fontFamily:'TimesNewRoman'}} variant="outlined">Next</Button>
                    </div>
