...
//     })
//  console.log("cardProps===========>", this.state.cardProps);
...
advancedCardSelected=()=>{
    ...
    return(
      <div  className='secondCard_front_back'>
        ...
        <div className="secondcard2" >
          <Card className="front1"onClick={this.basicCardSelected} style={{backgroundColor:this.props.card==='basic'?this.props.color:this.state.color}}>
  ...
  serviceMap=()=>{
    ...
    <Card className="back" style={{backgroundColor:'gray'}}><div>{this.state.status}</div></Card>
      </div>
      <div className="secondcard">
        <Card className="front" onClick={this.advancedCardSelected} style={{backgroundColor:this.props.card==='advance'?this.props.color:this.state.color}}  >
            <div className='whole_FirstCard_Div_Content'>
              <div className='Card_Content'>
