...
namespace Common.Models.NotesModels
{
    public class NotesModelView
    {
        ...
        private List<CollaboratorsModel.CollaboratorsModel> collaborators;
        ...
        public List<CollaboratorsModel.CollaboratorsModel> Collaborators
        {
